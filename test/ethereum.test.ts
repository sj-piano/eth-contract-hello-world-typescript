...
describe("Ethereum private key", function () {
  ...
  describe("Test basic transactions", function () {
    ...
    it("Should transfer 0 wei", async function () {
      ...
      let addr1Balance = await ethereum.getBalanceETH({ provider, address: addr1.address });
      let addr2Balance = await ethereum.getBalanceETH({ provider, address: addr2.address });
      let amountWei = "0";
      ...
      let addr1Balance2 = await ethereum.getBalanceETH({ provider, address: addr1.address });
      let addr2Balance2 = await ethereum.getBalanceETH({ provider, address: addr2.address });
    ...
    it("Should transfer 1 wei", async function () {
      ...
      let { txFeeWei, txFeeEth } = await ethereum.getTxFees({ provider, txHash });
